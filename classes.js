const CLASSES = [
  {
    ...
    poderes: [
      { nome: "Caçador de Tesouros", custo: "★2", descricao: "Quando seu grupo se aventura pelo mapa do mundo, você faz uma descoberta se tirar 【NP + 1】 ou menos na rolagem de viagem (em vez de apenas 1)." },
      { nome: "Companheiro Fiel", custo: "★5", descricao: "Com a ajuda do grupo, crie um NPC construto, elemental, fera ou planta de nível 5 para ser seu companheiro. Essa criatura não tem iniciativa, não sobe de nível, pode ter no máximo dois ataques básicos, ganha bônus em Precisão e Magia igual a 【NP】 e seus PV máximos são 【(NP × dado de Vigor) + metade do seu nível】. Você pode gastar sua ação para fazê-lo realizar uma ação no seu turno." },
      { nome: "Papo de Taverna", custo: "★3", descricao: "Ao descansar em uma estalagem ou taverna, você pode fazer 【NP】 perguntas ao mestre sobre os arredores e habitantes. O mestre deve responder com informações verdadeiras, mas você deve descrever como obteve tais informações." },
      { nome: "Prático", custo: "★4", descricao: "Você recupera 【NP】 PI após cada rolagem de viagem." },
  ...
  },
  {
    ...
    poderes: [
      ...
      { nome: "Arcano Emergencial", custo: "★6", descricao: "Enquanto estiver em crise, o custo de invocar seu Arcano é reduzido em 【NP × 5】." },
      { nome: "Círculo Arcano", custo: "★4", descricao: "Em seu turno, após dispensar voluntariamente um Arcano durante um conflito, se esse Arcano não foi invocado durante esse mesmo turno e você tem uma arma arcana equipada, pode imediatamente fazer a ação Feitiço sem custo de ação. O feitiço deve ter custo total de PM igual ou inferior a 【NP × 5】." },
      { nome: "Regeneração Arcana", custo: "★2", descricao: "Ao invocar um Arcano, você imediatamente recupera 【NP × 5】 PV." },
  ...
  },
  {
    ...
    poderes: [
      { nome: "Constelação do Boitatá", custo: "★3", descricao: "Use uma ação e gaste 10 PM: teste 【AST + VON】 vs Def.M de um inimigo. Se acertar, causa 【NP × 10】 de dano de fogo. Consumindo uma carga celeste, uma criatura torna-se Resistente a fogo até o fim da cena. Após usar, gera 【NP】 cargas solares." },
      { nome: "Constelação do Boto", custo: "★3", descricao: "Use uma ação e gaste 5 PM: um aliado que você veja pode trocar um Atributo de um teste por AST até o fim da cena. Consumindo uma carga solar, o alvo recebe +1 no teste. Após usar, gera 【NP】 cargas estelares." },
      ...
      { nome: "Constelação da Malora", custo: "★3", descricao: "Use uma ação e gaste 5 PM: teste oposto 【AST + VON】 vs inimigo. Se vencer, o inimigo fica abalado. Consumindo uma carga estelar, o alvo fica Vulnerável a fogo até o fim da cena. Após usar, gera 【NP】 cargas meteóricas." },
      { nome: "Constelação do Saci", custo: "★3", descricao: "Use uma ação e gaste 10 PM: um aliado que você veja pode fazer um ataque livre. Consumindo uma carga meteórica, o alvo recebe +1 na Defesa até o fim da cena. Após usar, gera 【NP】 cargas celestes." }
    ],
    cor: "#1a6b8a",
    emoji: "⭐"
  },
  {
    ...
    poderes: [
      ...
      { nome: "Maestria com Armas à Distância", custo: "★4", descricao: "Você ganha bônus igual a 【NP】 em testes de Precisão à distância." },
      { nome: "Olhos de Águia", custo: "★5", descricao: "Quando faz a ação Guarda sem dar cobertura: o próximo ataque à distância causa 【NP × 2】 de dano adicional, ou você pode imediatamente fazer um ataque livre com arco ou arma de fogo (RA = 0 para o dano)." },
      { nome: "Tiro de Aviso", custo: "★4", descricao: "Após atingir alvos com um ataque à distância, você pode escolher não causar dano. Se fizer isso: cada alvo atingido fica abalado, ou lento, ou perde 【NP × 10】 PM." }
    ],
    cor: "#8a5a1a",
    emoji: "🏹"
  },
  {
    ...
    poderes: [
      { nome: "Cabra da Peste", custo: "★5", descricao: "Uma vez por cena, se estiver em crise: use uma ação e gaste 1 Ponto de Fábula para se recuperar de todas as condições e recuperar PV igual a 【NP × 10】. Se gastar 1 Ponto de Ultima, também recupera PM igual a 【NP × 5】." },
      { nome: "Líder de Bando", custo: "★3", descricao: "Em um conflito, quando você faz uma ação entre Feitiço, Guarda ou Poder para beneficiar outro PJ, o alvo também recebe bônus igual a 【NP】 em testes de Precisão e Magia até o fim do próximo turno dele." },
      { nome: "Redistribuir Riquezas", custo: "★3", descricao: "Sempre que um vilão for vencido pelos PJs, você recebe 【1d6 × NP】 PI para distribuir. Se o vilão tiver mais de 1 Ponto de Ultima ao fim do conflito, você 'rouba' 1 Ponto de Ultima dele." },
  ...
  },
  {
    ...
    poderes: [
      ...
      { nome: "Carta Armadilha", custo: "★4", descricao: "Após um inimigo fazer uma ação num conflito, declare um naipe. Ponha a primeira carta do fundo do baralho na pilha de descarte. Se for curinga ou o naipe declarado, faça a ação Feitiço sem custo de ação (feitiço com custo ≤ 【NP × 5】 PM)." },
      { nome: "Cartas Mágicas", custo: "★3", descricao: "Use uma ação e gaste até 【10 + (NP × 5)】 PM: use o efeito de uma carta da mão para cada 5 PM gastos (máximo 5 cartas formando um conjunto). Depois, descarte as cartas usadas e compre a mesma quantidade." },
  ...
  },
  {
    ...
    poderes: [
      { nome: "Alma Ferida", custo: "★5", descricao: "Uma vez por cena, ao entrar em crise: crie um Laço de desconfiança com até 【NP】 inimigos que você veja. Esses Laços duram até o fim da cena e não precisam apagar Laços pré-existentes." },
      { nome: "Coração Ardente", custo: "★3", descricao: "Enquanto estiver sob efeito de uma forma mágica, ao evocar um Laço de desconfiança, inferioridade e/ou ódio em teste de Precisão ou Magia para causar dano, você causa 【NP × 10】 de dano adicional do mesmo tipo." },
  ...
  },
  {
    ...
    poderes: [
      { nome: "Carga de Cavalaria", custo: "★5", descricao: "Use uma ação e gaste 10 PM: escolha um aliado que possa ouvi-lo. O aliado faz imediatamente um ataque livre com bônus de Precisão igual ao seu 【NP】 (porém RA = 0 para o dano)." },
      ...
      { nome: "Decreto do Bispo", custo: "★5", descricao: "Use uma ação e gaste 10 PM: todos os custos em PM são dobrados; ou todas as fontes de dano causam 【NP × 3】 de dano adicional." },
      { nome: "Gambito da Dama", custo: "★6", descricao: "Use uma ação: faça um ataque livre (RA = 0 para o dano). Após o ataque, use imediatamente Decreto do Bispo, Carga de Cavalaria ou Roque do Rei sem ação (mas gasta o PM); ou um aliado recupera 【5 + (NP × 5)】 PV." },
      { nome: "Roque do Rei", custo: "★4", descricao: "Use uma ação e gaste 10 PM: nenhuma criatura pode recuperar PV ou PM; ou todos os efeitos que restauram PM restauram 【NP × 5】 PM adicionais. Dura até o início do seu próximo turno." }
    ],
    cor: "#1a4a8a",
    emoji: "👑"
  },
  {
    ...
    poderes: [
      { nome: "Dança", custo: "★10", descricao: "Sempre que adquirir esse poder, aprenda uma dança. Em seu turno em um conflito, sem armadura marcial equipada, gaste 10 PM para apresentar uma dança (antes ou depois de sua ação). Se já apresentou uma dança diferente no turno anterior na mesma cena, o custo é reduzido em 5 PM." },
      { nome: "Dançarino de Guerra", custo: "★5", descricao: "Após apresentar uma dança, seus ataques com adaga, arremesso, luta e malho causam 【NP】 de dano adicional até o início do próximo turno. Se tiver arma arcana, feitiços ofensivos também causam 【NP】 de dano adicional." },
      ...
      { nome: "Sapateado Frenético", custo: "★2", descricao: "Ao apresentar uma dança de duração 'até o início de seu próximo turno', todos os testes opostos de acrobacia, coordenação ou velocidade recebem bônus igual a 【NP × 2】." },
  ...
  },
  {
    ...
    poderes: [
      { nome: "Artilharia Mágica", custo: "★3", descricao: "Quando lança um feitiço ofensivo com arma arcana equipada, recebe bônus igual a 【NP × 2】 no teste de Magia." },
      { nome: "Cataclismo", custo: "★3", descricao: "Ao lançar feitiço de duração 'instantânea' com arma arcana, aumente o custo total em até 【NP × 10】 PM: para cada 10 PM extras, cada criatura sofre +5 pontos de dano." },
      ...
      { nome: "Lâmina Mágica", custo: "★4", descricao: "Ao lançar feitiço ofensivo (custo ≤ 【NP × 10】 PM) com alvo único, usando adaga/arco/espada/lança/luta/malho, pode usar a fórmula de Precisão da arma em vez do teste de Magia." },
      { nome: "Magia Elemental", custo: "★10", descricao: "Sempre que adquirir, aprenda um feitiço de Elementalista. Feitiços ofensivos usam 【AST + VON】 no teste de Magia." }
    ],
    cor: "#c43a1a",
    emoji: "🔥"
  },
  {
    ...
    poderes: [
      { nome: "Absorver PM", custo: "★5", descricao: "Depois de sofrer dano, você pode imediatamente recuperar 【NP × 2】 PM." },
      ...
      { nome: "Magia Entrópica", custo: "★10", descricao: "Sempre que adquirir, aprenda um feitiço de Entropista. Feitiços ofensivos usam 【AST + VON】 no teste de Magia." },
      ...
      { nome: "Tempo Roubado", custo: "★4", descricao: "Durante um conflito, use uma ação e gaste até 【NP × 5】 PM: para cada 5 PM, escolha uma opção — deixar uma criatura lenta, remover lentidão, fazer ela agir imediatamente, ou fazer um aliado agir logo após você." }
    ],
    cor: "#1a5a6b",
    emoji: "🎲"
  },
  {
    ...
    poderes: [
      { nome: "Análise Rápida", custo: "★6", descricao: "No início de um conflito, gaste até 【NP × 5】 PM: para cada 5 PM, o mestre revela um Traço de uma criatura, ou revela a Afinidade de uma criatura a um tipo de dano escolhido." },
      { nome: "Concentrado", custo: "★5", descricao: "Ao fazer um teste aberto usando 【AST + AST】, você ganha bônus igual a 【NP】 naquele teste (funciona apenas em testes abertos). Além disso, aumente permanentemente seus PM máximos em 【NP × 3】." },
      ...
      { nome: "Lampejo de Saber", custo: "★3", descricao: "Quando tira 13 ou mais em um teste de investigação (inclusive ação Estudo), pode fazer até 【NP】 perguntas ao mestre sobre o tópico. Só pode ser usado uma vez para a mesma criatura, item ou local." },
  ...
  },
  {
    ...
    poderes: [
      { nome: "Dons Psíquicos", custo: "★5", descricao: "Sempre que adquirir este poder, você recebe um dom. Dons só podem ser usados em reação a eventos específicos, gastando PM igual a 【5 × seções preenchidas no Relógio Mental】 (mínimo 5 PM)." },
      { nome: "Foco Cognitivo", custo: "★5", descricao: "No início do seu turno em conflito, escolha um aliado ou inimigo abalado/atordoado/enfurecido: essa criatura é seu foco. Bônus de 【NP】 em testes para examinar o foco e em Precisão/Magia contra ele. Curas ao foco recuperam 【NP × 2】 a mais." },
      { nome: "Hipercognição", custo: "★5", descricao: "O custo total em PM de seus feitiços e versos que têm seu foco entre os alvos é reduzido em 【NP】; ou em 【NP × 2】 se o foco for o único alvo (mínimo 0 PM)." },
  ...
  },
  {
    ...
    poderes: [
      ...
      { nome: "Magia Espiritual", custo: "★10", descricao: "Sempre que adquirir, aprenda um feitiço de Espiritualista. Feitiços ofensivos usam 【AST + VON】 no teste de Magia." },
      { nome: "Poder Curativo", custo: "★2", descricao: "Ao lançar feitiço com alvo em aliados, com arma arcana equipada, cada aliado alvo recupera PV igual a 【NP multiplicado pelo número de Laços que você tem】." },
  ...
  },
  {
    ...
    poderes: [
      { nome: "Árvore da Vida", custo: "★5", descricao: "Ao remover uma magissemente do jardim, escolha uma criatura que veja: se estiver em crise, ela recupera 【5 + (NP × 5)】 PV." },
      { nome: "Cloromancia", custo: "★10", descricao: "Sempre que adquirir, conheça um tipo diferente de magissemente. Durante um conflito, sem magissementes no jardim, use uma ação e gaste 20 PM para plantar uma magissemente de um tipo que conheça." },
      ...
      { nome: "Jardinagem Marcial", custo: "★3", descricao: "Após plantar uma magissemente via Cloromancia (não Enxerto): faça um ataque livre com arma equipada; ou faça a ação Feitiço sem ação (custo ≤ 【5 + (NP × 5)】 PM). RA = 0 para o dano." }
    ],
    cor: "#2a8a3a",
    emoji: "🌸"
  },
  {
    ...
    poderes: [
      ...
      { nome: "Runa Defensiva", custo: "★5", descricao: "Sempre que adquirir, aprenda uma característica defensiva de armas (custo ≤ 500z + (nível × 40z)). Faça a ação Inventário e gaste 2 PI para incrustar uma runa em uma arma ao alcance, aplicando os efeitos até o fim da cena." },
      { nome: "Runa Elemental", custo: "★5", descricao: "Sempre que adquirir, escolha um feitiço ofensivo de elementalista. Esse feitiço pode ser incrustado como runa — um personagem equipado com o item pode fazer a ação Feitiço para lançá-lo normalmente. Após isso, o efeito da runa termina." },
      { nome: "Runa Ofensiva", custo: "★5", descricao: "Sempre que adquirir, aprenda uma característica ofensiva de armas (custo ≤ 500z + (nível × 40z)). Funciona como Runa Defensiva." }
    ],
    cor: "#6b4a1a",
    emoji: "⚒️"
  },
  {
    ...
    poderes: [
      { nome: "Adrenalina", custo: "★5", descricao: "Enquanto estiver em crise, você causa 【NP × 2】 de dano adicional (seja através de ataques, feitiços, Arcanos, itens ou qualquer outro meio)." },
      { nome: "Espírito Indomável", custo: "★4", descricao: "Quando gasta um ou mais Pontos de Fábula, receba um benefício adicional: recupera 【NP × 5】 PV; ou recupera 【NP × 5】 PM; ou se recupera de uma única condição à sua escolha." },
      ...
      { nome: "Provocar", custo: "★5", descricao: "Use uma ação e gaste 5 PM: teste oposto 【VIG + VON】 vs uma criatura. Se passar, o alvo fica enfurecido e compelido a focar em você. Você ganha bônus de 【NP】 neste teste." },
      { nome: "Resistir", custo: "★5", descricao: "Quando faz a ação Guarda sem dar cobertura: recupera PV igual a 【NP × maior força de Laço】 e escolhe Vigor ou Vontade. Até o fim do próximo turno, o dado do Atributo escolhido é um passo maior." }
    ],
    cor: "#c41a1a",
    emoji: "⚔️"
  },
  {
    ...
    poderes: [
      { nome: "Cozinheiro Viajante", custo: "★3", descricao: "Após cada rolagem de viagem, se tiver o poder Culinária, você recebe 【NP × 2】 ingredientes." },
      { nome: "Culinária", custo: "★5", descricao: "Ao descansar em um assentamento, receba 【NP】 ingredientes. Use uma ação e combine 2 ou 3 ingredientes para preparar uma iguaria. Escolha: aplique em você e um aliado; ou faça um ataque livre (sem dano) para aplicar em inimigos atingidos." },
      { nome: "Feito com Amor", custo: "★3", descricao: "Quando usa Culinária para aplicar efeito em aliados, gaste até 【NP × 10】 PM: para cada 10 PM, aplique o efeito em um aliado adicional." },
  ...
  },
  {
    ...
    poderes: [
      ...
      { nome: "Fortaleza", custo: "★5", descricao: "Aumente permanentemente seus PV máximos em 【NP × 3】." },
      ...
      { nome: "Maestria Defensiva", custo: "★5", descricao: "Enquanto tiver escudo ou armadura marcial equipada, todo dano sofrido é reduzido em 【NP】 (aplicado antes de Afinidades)." },
  ...
  },
  {
    ...
    poderes: [
      { nome: "Agonia", custo: "★5", descricao: "Quando causa dano a uma ou mais criaturas, se tiver um Laço com pelo menos uma delas, você recupera 【NP × 2】 PV e 【NP × 2】 PM." },
      ...
      { nome: "Golpe das Sombras", custo: "★5", descricao: "Use uma ação: role seu dado de Vigor e perca essa quantidade de PV. Se não reduzir seus PV a 0, faça um ataque livre. Se acertar, cause dano adicional igual a 【NP + número rolado no dado de Vigor】 em trevas (tipo não pode ser alterado)." },
      { nome: "Lição Dolorosa", custo: "★3", descricao: "Quando outra criatura faz você perder PV, pode fazer a ação Estudo imediatamente, com bônus igual a 【NP】 no teste. Só pode estudar o mesmo aspecto uma vez." },
  ...
  },
  {
    ...
    poderes: [
      { nome: "Chuva de Poções", custo: "★2", descricao: "Quando cria uma poção que restaura PV e/ou PM de uma única criatura, pode fazê-la afetar até 【NP】 criaturas adicionais. Se fizer isso, a poção restaura apenas metade da quantidade normal de PV e PM para cada criatura." },
      { nome: "Engenhocas", custo: "★5", descricao: "Sempre que adquirir pela primeira vez, escolha um tipo de engenhoca: Alquimia, Infusões ou Tecnomagia. Você ganha os benefícios básicos. Ao adquirir novamente, escolha: benefícios básicos de novo tipo; ou benefícios avançados; ou benefícios superiores." },
      { nome: "Fórmula Secreta", custo: "★5", descricao: "Poções/magisferas que restauram PV/PM restauram 【NP × 5】 a mais. Fragmentos elementais, magisferas e poções que causam dano causam 【NP】 de dano adicional." },
  ...
  },
  {
    ...
    poderes: [
      { nome: "Cascata", custo: "★5", descricao: "Após um inimigo que você veja perder PV graças ao dano de um aliado com dano adicional de uma invocação tipo 'Praga', pode fazer um ataque livre contra esse inimigo com bônus de 【NP】. Se acertar, o dano é do mesmo tipo e as invocações 'Praga' no alvo se dissipam." },
      { nome: "Expandir Manancial", custo: "★5", descricao: "Com arco, arma arcana, arma arremessável, arma de luta, espada ou mangual equipada: suas invocações 'explosão' causam 【NP】 de dano adicional e o dano adicional de invocações 'praga' aumenta em 【NP】." },
      { nome: "Harmonia Elemental", custo: "★2", descricao: "Você consegue se comunicar verbalmente com criaturas elementais. Ao restaurar PV de uma criatura com invocação ou feitiço, se houver um elemental na cena, o efeito restaura 【NP × 5】 PV adicionais." },
      { nome: "Invocação", custo: "★3", descricao: "Use uma ação e gaste 5 PM: faça uma invocação acessando a energia de um dos mananciais presentes na cena. Seu 【NP】 determina a quais invocações você tem acesso." },
      { nome: "Invocações Conectadas", custo: "★3", descricao: "Ao fazer uma invocação, gaste até 【NP × 10】 PM adicionais: a cada 10 PM, a invocação pode ter uma criatura adicional que você veja como alvo." }
    ],
    cor: "#1a7a6b",
    emoji: "🌊"
  },
  {
    ...
    poderes: [
      { nome: "Alta Velocidade", custo: "★3", descricao: "No início de um conflito, gaste 10 PM: faça um ataque livre, ou faça a ação Impedimento ou Objetivo — isso acontece antes da primeira rodada. Você também ganha bônus de 【NP】 nos testes da opção escolhida." },
      { nome: "Esquiva", custo: "★3", descricao: "Enquanto não tiver escudos ou armaduras marciais equipadas, sua Defesa aumenta em 【NP】." },
      { nome: "Golpe Baixo", custo: "★5", descricao: "Quando atinge uma criatura com um ataque, e apenas ela for o alvo e estiver sofrendo uma ou mais condições, você causa dano adicional igual a 【NP + número de condições】." },
      { nome: "Roubo de Alma", custo: "★5", descricao: "Use uma ação: teste 【DES + VON】 vs Def.M. Se o alvo for soldado, recupere 【NP】 PI. Se for elite ou campeão, receba o tesouro da alma (item com valor ≤ nível × 30 ou 50 para vilão). Ganha bônus de 【NP】 neste teste." },
  ...
  },
  {
    ...
    poderes: [
      ...
      { nome: "Frenesi Sanguinolento", custo: "★3", descricao: "Uma vez por cena, ao entrar em crise ou ser reduzido a 0 PV: gaste 1 Ponto de Fábula para recuperar 【NP × 10】 PV." },
      { nome: "Hemofagia", custo: "★5", descricao: "Uma vez por rodada, quando outra criatura faz você perder PV: gaste 10 PV para fazer um ataque livre contra ela. Se acertar, causa 【NP + RA】 de dano físico (sem dano da arma). Com sucesso crítico, pode recuperar PV iguais ao dano causado." }
    ],
    cor: "#8a1a1a",
    emoji: "🩸"
  },
  {
    ...
    poderes: [
      { nome: "Engabelar", custo: "★3", descricao: "Uma vez por cena, quando uma criatura na cena faz um teste, gaste 10 PM para fazer o mesmo teste com bônus ou penalidade de 【NP】. Então você pode trocar seu resultado com o do alvo. Até o fim da cena, pode usar o resultado trocado num dos seus testes." },
      ...
      { nome: "Gambiarra", custo: "★4", descricao: "Uma vez por cena, faça a ação Inventário e gaste até 【NP × 2】 PI para modificar uma arma equipada. Para cada 2 PI: +1 em Precisão; ou +2 de dano; ou +1 em testes de Objetivo; ou troca o alcance. As modificações duram até o fim da cena." },
      { nome: "Golpe Aproveitador", custo: "★3", descricao: "Quando faz um ataque contra uma única criatura sofrendo uma ou mais condições, pode trocar um atributo do teste de Precisão por DES e recebe bônus de 【NP】 no teste." },
      { nome: "Jeitinho", custo: "★2", descricao: "Quando um aliado passar em um teste para preencher/apagar seções de um relógio, gaste até 【NP × 20】 PM: você não pode fazer testes para influenciar o relógio nesta rodada, mas preenche/apaga uma seção para cada 20 PM gastos." }
    ],
    cor: "#5a4a1a",
    emoji: "🎩"
  },
  {
    ...
    poderes: [
      { nome: "Data de Validade", custo: "★3", descricao: "Quando uma poção ou iguaria que você criou não causar dano, mas fizer criaturas recuperarem PV: pode fazê-la causar dano de veneno igual a 【metade do nível + (NP × 10)】 a essas criaturas (dividido à metade para 2+ criaturas)." },
      { nome: "Estoque Pessoal", custo: "★3", descricao: "Quando você ou outro PJ for gastar 【NP + 2】 ou menos Pontos de Inventário, você pode gastar 1 Ponto de Comércio para o alvo ignorar esse custo." },
      { nome: "Já Ouvi Falar", custo: "★3", descricao: "Quando você ou um aliado fizer um teste para examinar uma criatura, item ou local, gaste 1 Ponto de Comércio para conferir bônus de 【NP + 2】 ao resultado do teste." },
      { nome: "Ventos do Comércio", custo: "★3", descricao: "Após descansar numa área de comércio, receba 【NP + 1】 Pontos de Comércio (máximo 【NP + 3】). Em cenas sem conflito, gaste 2 Pontos de Comércio para criar um item raro (valor ≤ nível × 30z) ou criar um NPC com serviços." },
      { nome: "Verdadeiro Tesouro", custo: "★3", descricao: "Uma vez por sessão, ao ajudar um NPC ou comunidade a superar ganância ou melhorar a qualidade de vida, se tiver Ventos do Comércio, receba 【NP + 1】 Pontos de Comércio." }
    ],
    cor: "#6b5a1a",
    emoji: "💰"
  },
  {
    ...
    poderes: [
      ...
      { nome: "Quebra-ossos", custo: "★4", descricao: "Quando atinge alvos com ataque corpo a corpo, pode escolher não causar dano: cada alvo atingido fica atordoado; ou fica fraco; ou perde 【NP × 10】 PM." },
      { nome: "Maestria com Armas Corpo a Corpo", custo: "★4", descricao: "Você ganha bônus igual a 【NP】 em testes de Precisão corpo a corpo." },
      { nome: "Trespassar", custo: "★3", descricao: "Use uma ação e gaste 5 PM: faça um ataque livre corpo a corpo contra um único alvo. Se acertar, sem causar dano, escolha: destrua um escudo; ou destrua a armadura do alvo; ou o alvo sofre 【NP × 2】 de dano adicional toda vez que sofrer dano antes do início do próximo turno." }
    ],
    cor: "#4a3a1a",
    emoji: "🗡️"
  },
  {
    ...
    poderes: [
      { nome: "Acromorfose", custo: "★3", descricao: "Seus testes de Precisão para ataques desarmados recebem bônus de 【NP】 e causam 【6 + (NP × 2)】 de dano adicional. No início do turno em conflito, pode escolher uma categoria de arma — seus ataques desarmados pertencem a essa categoria até o início do próximo turno." },
      { nome: "Biofagia", custo: "★4", descricao: "Se estiver em crise, recupere 【NP × 5】 PV depois que um de seus ataques ou feitiços ofensivos fizer um ou mais inimigos perderem PV." },
      ...
      { nome: "Genoclepse", custo: "★2", descricao: "Quando causar dano a um ou mais NPCs, você pode descobrir sua espécie. O mestre deve escolher 【NP】 terioformas que reflitam esses NPCs. Se tiver Teriomorfose, pode pagar o custo em PV imediatamente para usá-las." },
      { nome: "Teriomorfose", custo: "★6", descricao: "Sempre que adquirir, aprenda uma terioforma. Use uma ação e gaste um terço dos seus PV atuais para manifestar os efeitos de até duas terioformas que aprendeu. Os efeitos duram até o fim da cena." }
    ],
    cor: "#3a5a1a",
    emoji: "🧬"
  },
  {
    ...
    poderes: [
      { nome: "Além do Reino da Morte", custo: "★5", descricao: "Quando outra criatura em crise perde PV e não for morto-vivo, receba 1 Ponto de Túmulo (máximo NP + 1). Ao ser reduzido a 0 PV, perde todos os Pontos de Túmulo; se for a primeira vez na cena, em vez de se render, recupera PV igual a 【NP × Pontos de Túmulo perdidos】." },
      ...
      { nome: "Medo é a Chave", custo: "★3", descricao: "Após fazer um ou mais inimigos perderem PV, se tiver Além do Reino da Morte e ao menos um desses inimigos estiver abalado e/ou fraco, você recebe 1 Ponto de Túmulo e recupera 【NP × 2】 PV e PM." },
      { nome: "Por Quem os Sinos Dobram", custo: "★3", descricao: "Ao causar dano com feitiço a uma única criatura, gaste 1 Ponto de Túmulo: se estiver sofrendo condições, o feitiço causa dano adicional de 【(NP × 2) + número de condições】; ou se não tiver condições, ela fica abalada." },
  ...
  },
  {
    ...
    poderes: [
      ...
      { nome: "Condenar", custo: "★4", descricao: "Use uma ação e gaste 5 PM: teste oposto 【AST + VON】 vs criatura que possa ouvir e entender suas acusações. Se vencer, o alvo perde 【NP × 10】 PM e fica abalado ou atordoado. Ganha bônus de 【NP】 neste teste." },
      { nome: "Confio em Você", custo: "★2", descricao: "Quando outro PJ que pode ouvi-lo fizer um teste, gaste 1 Ponto de Fábula para convocar um Traço ou Laço dele, permitindo que role os dados novamente. Se você tem um Laço com o alvo, ele recupera 【NP × 10】 PM." },
      { nome: "Encorajar", custo: "★6", descricao: "Durante um conflito, use uma ação e gaste 5 PM: uma criatura que possa ver e entender você recupera 【NP × 5】 PV. Ela escolhe um Atributo — o dado atual desse Atributo é um passo maior até o início do seu próximo turno." },
      { nome: "Persuasivo", custo: "★2", descricao: "Quando passar em um teste para preencher/apagar seções de um relógio via charme, diplomacia, enganação ou intimidação, gaste até 【NP × 20】 PM: preenche/apaga uma seção adicional para cada 20 PM gastos." }
    ],
    cor: "#1a4a6b",
    emoji: "🗣️"
  },
  {
    ...
    poderes: [
      ...
      { nome: "Configuração Flexível", custo: "★4", descricao: "Ao usar a ação Equipamento ou Guarda enquanto pilota seu veículo pessoal, escolha até 【NP】 módulos ativos e desative-os. Escolha um número igual de módulos inativos e os ative." },
      { nome: "Coração no Motor", custo: "★3", descricao: "No início do seu turno em conflito, se estiver pilotando seu veículo pessoal, gaste 10 PM: na próxima vez que causar dano, cause 【NP × 2】 adicional; ou reduza o próximo dano sofrido em 【NP × 2】; ou se recupere de lento ou fraco." },
  ...
  },
  {
    ...
    poderes: [
      { nome: "Consumir", custo: "★5", descricao: "Quando causa dano a uma ou mais criaturas usando um feitiço, caso tenha uma adaga, arma arcana ou malho equipada, você recupera 【NP × 2】 PM." },
      { nome: "Imitação Mágica", custo: "★10", descricao: "Quando vê um feitiço sendo lançado por uma criatura fera, monstro ou planta, pode aprendê-lo imediatamente. Você pode memorizar até 【NP + 2】 feitiços de Quimerista. Feitiços ofensivos usam 【AST + VON】 ou 【VIG + VON】 (escolha ao adquirir o poder)." },
  ...
  },
  {
    ...
    poderes: [
      ...
      { nome: "Simbolismo", custo: "★5", descricao: "Sempre que adquirir, aprenda dois símbolos. Você pode ter até 【NP + 1】 símbolos ativos. Faça a ação Inventário e gaste 2 PI: aplique um símbolo em si mesmo, em um aliado, ou faça um ataque livre (sem dano) para aplicar em inimigos atingidos." },
      { nome: "Símbolos Mágicos", custo: "★3", descricao: "Se um aliado estiver com um de seus símbolos, ele pode fazer a ação Feitiço para destruir o símbolo e lançar um feitiço que você conhece (custo ≤ 【NP × 10】 PM, pago pelo aliado)." },
      { nome: "Toque Pessoal", custo: "★5", descricao: "Quando uma criatura que você veja e que tenha um de seus símbolos sofrer dano ou recuperar PV/PM, você pode fazer a criatura sofrer 【NP】 de dano adicional ou recuperar 【NP】 PV e/ou PM." }
    ],
    cor: "#4a1a5a",
    emoji: "🎨"
  },
  {
    ...
    poderes: [
      { nome: "Barreira Sonora", custo: "★5", descricao: "Após cantar um verso em volume médio ou forte, qualquer quantidade de dano físico que você sofrer até o início do seu próximo turno é reduzido em 【NP】 (antes de Afinidades)." },
      ...
      { nome: "Harmonia", custo: "★3", descricao: "Após afetar um ou mais inimigos com um verso, com arma arcana equipada: até o início do próximo turno, seus aliados causam 【NP】 de dano adicional a esses inimigos; ou você recupera 【NP】 PM cada vez que esses inimigos sofrerem dano." },
      { nome: "Magicanto", custo: "★10", descricao: "Em seu turno em conflito, use uma ação e gaste PM variável para cantar um verso (combinação de volume, escala e tom). Ao adquirir este poder, você aprende todos os três volumes, uma escala e um tom. Ao adquirir novamente, aprenda mais uma escala ou tom." },
